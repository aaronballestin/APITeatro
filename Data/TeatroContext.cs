    ...
    public class TeatroContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Sala>().HasData(
                new Sala { SalaId = 1, AsientosNormales = 50, AsientosMinusvalidos = 10, AsientosVip = 10 },
                new Sala { SalaId = 2, AsientosNormales = 100, AsientosMinusvalidos = 0, AsientosVip = 0 },
                new Sala { SalaId = 3, AsientosNormales = 0, AsientosMinusvalidos = 0, AsientosVip = 30 }
            ...
            modelBuilder.Entity<Compra>().HasData(
                ...
                new Compra { CompraId = 2, SesionId = 1, UsuarioId = 2 }
            );
            ...
            modelBuilder.Entity<DetallesCompra>().HasData(
                ...
                new DetallesCompra { CompraId = 2, SesionId = 2, AsientoId = 2 },
                new DetallesCompra { CompraId = 2, SesionId = 1, AsientoId = 7 }
