    ...
    public class TeatroContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Asiento>().HasData(
                new Asiento { AsientoId = 1, SalaId = 1, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 2, SalaId = 1, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 3, SalaId = 1, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 4, SalaId = 1, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 5, SalaId = 1, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 6, SalaId = 1, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 7, SalaId = 1, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 8, SalaId = 1, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 9, SalaId = 1, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 10, SalaId = 1, TipoAsiento = 1, Suplemento = 0 },
                ...
                new Asiento { AsientoId = 52, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 53, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 54, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 55, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 56, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 57, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 58, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 59, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 60, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 61, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 62, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 63, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 64, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 65, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 66, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 67, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 68, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 69, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 70, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 71, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 72, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 73, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 74, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 75, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 76, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 77, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 78, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 79, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 80, SalaId = 2, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 81, SalaId = 3, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 82, SalaId = 3, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 83, SalaId = 3, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 84, SalaId = 3, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 85, SalaId = 3, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 86, SalaId = 3, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 87, SalaId = 3, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 88, SalaId = 3, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 89, SalaId = 3, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 90, SalaId = 3, TipoAsiento = 1, Suplemento = 0 },
                ...
                new Asiento { AsientoId = 111, SalaId = 3, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 112, SalaId = 3, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 113, SalaId = 3, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 114, SalaId = 3, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 115, SalaId = 3, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 116, SalaId = 3, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 117, SalaId = 3, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 118, SalaId = 3, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 119, SalaId = 3, TipoAsiento = 1, Suplemento = 0 },
                new Asiento { AsientoId = 120, SalaId = 3, TipoAsiento = 1, Suplemento = 0 }
            );
